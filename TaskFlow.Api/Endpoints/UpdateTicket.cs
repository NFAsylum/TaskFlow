...
{
    public static void MapUpdateTicketEndpoint(this IEndpointRouteBuilder app)
    {
        app.MapPut(Endpoints.TicketsWithIdEndpoint, async (AppDbContext db, int id, UpdateTicketRequest ticket) =>
        {
